...
namespace Enterprise.AuthorizationServer.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
            ...
            UrlEncoder urlEncoder)
        {
            ...
            logModel.SetModel(userScopesModel.Subject.ToString(), userScopesModel.Name, nameof(EnableAuthenticatorModel), ApplicationNames.AuthorizationServer, LogTypeEnum.Info);
            #endregion
        }
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Enterprise.AuthorizationServer"),
